...
- :house: 通讯地址：重庆市沙坪坝区沙正街重庆大学A区
- :school: 所在院系：机械与运载工程学院、船舶与海洋工程学院
- 项目题目：采用亚微米硅粉原料3D打印陶瓷汽车尾气过滤器
  - 大创项目介绍：作为项目的主要参与者，本项目在2018年6月中期答辩中被评审为国家级立项项目，并在2019年3月份顺利完成项目结题验收。本项目以亚微米硅粉为原料，采用3D打印技术成型，经无压氮化烧结制备氮化硅陶瓷汽车尾气过滤器。与现有产品相比，具有一次成型、简化后续胚体加工的特点，从而能够有效降低成本，产品具有耐高温、抗热冲击、抗氧化性能，并具备批量生产的可行性
- :man_factory_worker: 苏州西帝摩三维打印科技有限公司
...
:star: https://docs.qq.com/sheet/DWElhT3VVSm5WTHNY
...
| 序号 | 公司                                                         | 岗位                                                         | 地点  | 投递 | 流程更新                                                     |
| :--- | :----------------------------------------------------------- | ------------------------------------------------------------ | :---- | :--- | :----------------------------------------------------------- |
| 1    | [多益网络](https://xz.duoyi.com/center/center.html#applynotify) | 游戏研发                                                     | 成    | 7/17 | 测评挂`X`                                                    |
| 2    | [全志科技](https://campus.allwinnertech.com/campus-recruitment/allwinnertech/43436/#/candidateHome/applications) | 应用软件设计                                                 | 珠    | 7/17 | 候选人                                                       |
| 3    | [禾赛科技](https://kwh0jtf778.jobs.feishu.cn/referral/campus/position/application?token=MzsxNjU3Mjg5NzgxMDEyOzcxMTI2MTk2NDk0OTg0MzE0ODk7MA) | C++软件                                                      | 上    | 7/18 |                                                              |
| 4    | [联发科技](http://mediatek-campus2023.zhaopin.com/job.html)  | 嵌入式软件                                                   | 成    | 7/18 | 7/27笔试，？                                                 |
| 5    | [北森](http://beisen.zhiye.com/Portal/Apply/Index)           | 后端                                                         | 成    | 7/18 |                                                              |
| 6    | [中科芯](https://xiaoyuan.zhaopin.com/job/CC000370676J00101482788?productId=7) | 软件                                                         | 成    | 7/20 |                                                              |
| 7    | [趋势科技](https://trendmicro.zhiye.com/Portal/Apply/Index)`0` | C++软件开发                                                  | 南    | 7/20 | 08-05 19:00笔试，8/10 笔试挂`X`                              |
| 8    | [OPPO](https://careers.oppo.com/campus/record)`0`            | 驱动/系统                                                    | 成    | 7/20 | 简历挂`X`                                                    |
| 9    | [杭州大华](https://dahua.zhiye.com/Portal/Apply/Index)`0`    | C++大数据                                                    | 杭    | 7/20 | 7/25在线笔试                                                 |
| 10   | [北云科技](https://www.bynav.com/cn/careers/campus-recruitment/recruitment/925.html) | C/C++软件                                                    | 长    | 7/22 | 7/23笔试，8/2笔试，8/12一面，`X`                             |
| 11   | [集创北方](https://chipone.zhiye.com/Portal/Apply/Index)`0`  | 软件开发                                                     | 深    | 7/22 |                                                              |
| 12   | [海尔](http://maker.haier.net/client/campus/mydeliverydetail/did/141524/jpid/0.html) | 后端开发                                                     | 成    | 7/22 | 简历挂`X`                                                    |
| 13   | [元戎启行](https://app.mokahr.com/campus_apply/deeproute/6487#/candidateHome/resume) | 软件                                                         | 深    | 7/22 | 8/4，14：00一面，一面挂`X`                                   |
| 14   | [星猿哲XYZ](https://app.mokahr.com/campus_apply/xyzrobotics/26847#/candidateHome/applications) | C++开发                                                      | 上    | 7/23 | 7/27笔试                                                     |
| 15   | [万集科技](https://fpq5u8xh3h.jobs.feishu.cn/201211/position/application) | C++开发                                                      | 北    | 7/25 | 简历挂`X`                                                    |
| 16   | [最右](https://app.mokahr.com/campus_apply/xiaochuankeji/3518#/candidateHome/applications)`0` | 后台开发                                                     | 北    | 7/27 |                                                              |
| 17   | [联想](https://talent.lenovo.com.cn/resume/myapply)          | 通信-5G/6G                                                   | 重    | 7/27 |                                                              |
| 18   | [SmartX](https://app.mokahr.com/campus_apply/smartx/4183#/candidateHome/applications)`0` | 软件                                                         | 北    | 7/27 | 简历挂`X`                                                    |
| 19   | [中望](https://app.mokahr.com/campus_apply/zwcad/28356#/candidateHome/applications) | C++研发                                                      | 西    | 7/28 | 7/28笔试，8/5下午一面挂`X`                                   |
| 20   | [TCL华星光电](https://sc.hotjob.cn/wt/TCL/web/index/applyPositionN300!listApplyPosition?brandCode=1&operational=913b4b51fa4298809ba381fa6506eb0455bc82a967085d352b70abd1e7ada881246b7b5ebd947160c0cab86e1913315681a96ee70bb57c2ef238234c167cd0086c7e2195b16f546503dc2622ab7bfc2f8f4f8ccc5e14129bd82ca317aa0275cd) | C/C++软件开发                                                | 成    | 8/25 | 秋招重新投递                                                 |
| 21   | [蔚来](https://nio.jobs.feishu.cn/campus/position/application?spread=SAYV33H)`0` | 后端开发                                                     | 北    | 7/29 | 提前批简历挂`X`                                              |
| 22   | [ZOOM](https://www.nowcoder.com/users/570439010/deliver)     | [C++服务端开发](https://www.nowcoder.com/careers/zoom/102351?jobIds=75414) | 杭    | 7/29 | 08-10 19:00笔试                                              |
| 23   | [华为数存](https://career.huawei.com/reccampportal/portal5/appjob-campus.html) | 软件开发                                                     | 成    | 7/29 |                                                              |
| 24   | [京东发](http://campus.boe.com/Portal/Apply/Index)           | 软件开发                                                     | 重    | 7/29 |                                                              |
| 25   | [中电55所](https://xiaoyuan.zhaopin.com/scrd/delivery/record) | 软件研发                                                     | 南    | 7/30 |                                                              |
| 26   | [科大讯飞](https://campus.iflytek.com/official-pc/delivery)  | C++开发                                                      | 西    | 7/30 | 08-06 19:00:00笔试                                           |
| 27   | [招商证券](https://wecruit.hotjob.cn/SU629dbc0c0dcad452299bc0f7/pb/account.html#/myDeliver) | 后台开发                                                     | 武    | 7/30 |                                                              |
...
| 29   | [锐捷网络](https://app.mokahr.com/campus_apply/ruijie/56200?recommendCode=DSgE2uKR#/candidateHome/applications) | C/C++开发                                                    | 南    | 7/30 |                                                              |
| 30   | [深信服](https://app.mokahr.com/campus_apply/sangfor/27944#/candidateHome/applications) | C/C++软件开发                                                | 成    | 7/30 |                                                              |
| 31   | [北斗星通](https://mp.weixin.qq.com/s/HbN0t9lIQ7lnmgw320hP9A) | HMI（C++）                                                   | 重    | 7/30 |                                                              |
| 32   | [嘉楠](https://canaan-creative.zhiye.com/Portal/Apply/Index) | AI编译器                                                     | 北    | 7/30 | 简历挂`X`                                                    |
| 33   | [虹软](http://career.arcsoft.com.cn/Portal/Apply/Index)`0`   | C/C++开发                                                    | 杭    | 7/30 | 8/21晚上7点笔试                                              |
| 34   | [传音控股](https://transsion.zhiye.com/Portal/Apply/Index)   | 软件C/C++方向                                                | 重    | 8/1  | 8/22已测评                                                   |
| 35   | 爱立信                                                       | 软件开发C++                                                  | 上    | 8/1  |                                                              |
| 36   | [荣耀](https://career.hihonor.com/SU60eea919bef57c1023f6fe78/pb/account.html#/myDeliver) | 通用软件开发                                                 | 西    | 8/1  |                                                              |
| 37   | [诺瓦星云](https://novastar.zhiye.com/Portal/Apply/Index)`0` | 软件-C++                                                     | 西    | 8/1  | 8/9笔试                                                      |
| 38   | [滴滴](https://campus.didiglobal.com/campus_apply/didiglobal/6223#/candidateHome/applications) | 后端研发C++                                                  | 北    | 8/1  | 8/14上午10点面试,二面挂`X`                                   |
| 39   | [哲库](https://app.mokahr.com/campus-recruitment/zeku/47716#/candidateHome/applications)`0` | 软件开发                                                     | 成    | 8/1  | 简历挂`X`                                                    |
| 40   | [英特尔](https://chinacampus.jobs.intel.cn/intel/user/delivery) | Network Engineer                                             | 成    | 8/2  |                                                              |
| 41   | [美团](https://campus.meituan.com/apply-record)              | 软件开发                                                     | 成    | 8/2  | 调整到8/13笔试，2.6/5，**8/27笔试，下午4点**                 |
| 42   | [猿辅导](https://hr.yuanfudao.com/campus-recruitment/fenbi/47742/#/candidateHome/applications) | 服务端开发                                                   | 北    | 8/2  | 08-07 19:00笔试，笔试`X`                                     |
| 42   | [微软]()                                                     | Software - STCA                                              | 苏    | 8/2  | 8/5上午10点笔试，2/3，看病                                   |
| 43   | [网易游戏](https://game.campus.163.com/personal)             | 游戏研发                                                     | 广    | 8/3  |                                                              |
| 44   | [4399](https://hr.4399om.com/?r=userCenter/index)            | C++游戏开发                                                  | 广    | 8/3  | 08-18 19:00笔试，==ac==                                      |
| 45   | [招银网络科技](https://cmbntjob.cmbchina.com/pages/mycenter/default.html) | 软件开发                                                     | 成    | 8/5  | 8/12测评,**9月5日 19:00笔试**                                |
| 46   | [东方财富](https://zhaopin.eastmoney.com/campus-recruitment/eastmoney/57971#/candidateHome/applications) | 服务端开发C++                                                | 上    | 8/5  | 测评                                                         |
| 47   | [完美世界](https://recruit.games.wanmei.com/campus-recruitment/pwrd/45131/#/candidateHome/applications)`0` | 游戏C++服务端开发                                            | 北    | 8/6  | **08-27 14:00，90分钟**                                      |
| 48   | [Momenta](https://momenta.jobs.feishu.cn/campus/position/application?spread=5XK7MCD) | 后端开发—C++                                                 | 苏    | 8/6  |                                                              |
| 49   | [超参数科技](https://app.mokahr.com/campus-recruitment/chaocanshu/45562#/candidateHome/applications) | 后台开发                                                     | 深    | 8/6  | 简历挂`X`                                                    |
| 50   | [星环科技](https://app.mokahr.com/campus_apply/transwarp/3196#/candidateHome/applications) | C++后端开发                                                  | 南    | 8/6  |                                                              |
| 51   | [理想汽车](https://li.jobs.feishu.cn/referral/campus/position/application?token=MTsxNjU5MzYwNzc5NTU2OzcxMTk2MTkyOTcwMTg3NTcxMjM7NzEyNTc3NDQyMTM0MDQwODA5Nw)`0` | C++开发                                                      | 北    | 8/6  |                                                              |
| 52   | [==三一集团==](http://sanycampus.zhiye.com/Portal/Apply/Index) | 软件                                                         | 长    | 8/7  | 8/9 19:00笔试，8/20上午面试是终面，==OC==                    |
| 53   | [探探](https://app.mokahr.com/campus-recruitment/immomo/54299#/candidateHome/applications) | 后端                                                         | 北    | 8/7  |                                                              |
| 54   | [360](http://360campus.zhiye.com/personal/deliveryRecord)    | Web服务端开发                                                | 成    | 8/7  |                                                              |
| 55   | 民生科技                                                     | 技术研发                                                     | 成    |      | 牛客投递，已经测评                                           |
| 56   | [奇安信](https://app.mokahr.com/campus_apply/qianxin/29182?recommendCode=DSHgJJE8#/candidateHome/applications) | 服务端开发C/C++                                              | 成    | 8/8  | 08-25 19:00笔试，第二题最大盛雨水容器，输入问题，输入的数组是个包括左右[]的字符串，如`"[1,5,2,89,5]"` |
| 57   | [卡特彼勒](https://cat.wd5.myworkdayjobs.com/zh-CN/CaterpillarCareers/userHome)`外` | 软件开发                                                     | 无    | 8/8  |                                                              |
| 58   | [米哈游](https://campus.mihoyo.com/#/campus/applyRecord)     | 后端开发                                                     | 上    | 8/8  |                                                              |
| 59   | [芯驰](https://app.mokahr.com/campus_apply/semidrive/42941#/candidateHome/applications) | Application Platform Engineer                                | 上    | 8/8  |                                                              |
| 60   | [大疆](https://we.dji.com/zh-CN/user)                        | 后端开发                                                     | 深    | 8/9  | 8月14晚上7-8点笔试                                           |
| 61   | [网易雷火](https://campus.163.com/app/personal/apply)        | 游戏研发-服务端                                              | 杭    | 8/9  | 8/14下午2-5点笔试,巨难，放弃了                               |
| 62   | [旷视](https://app.mokahr.com/campus_apply/megviihr/38642?sourceToken=a20be0c2175b1ed1e9aa68098ce0c826#/candidateHome/applications) | 后端开发APU                                                  | 北    | 8/9  |                                                              |
| 63   | [远景](https://app.mokahr.com/campus-recruitment/envisiongroup/43123#/candidateHome/applications) | 软件开发                                                     | 上    | 8/10 |                                                              |
| 64   | 杰理科技                                                     | 软件                                                         | 珠    | 8/10 | 微信投递，**08-23笔试**                                      |
| 65   | [思特威](https://app.mokahr.com/campus_apply/smartsenstech1/56088?recommendCode=DSBsXw2j#/candidateHome/applications) | 软件开发                                                     | 上    | 8/10 |                                                              |
| 66   | 墨奇科技                                                     | 后端开发                                                     | 成    | 8/10 | 牛客投递，笔试挂`X`，垃圾公司                                |
| 67   | [英伟达](https://app.mokahr.com/campus-recruitment/nvidia/47111#/candidateHome/applications) | JR2100004 Software                                           | 深    | 8/10 |                                                              |
| 68   | [CVTE](https://careers.cvte.com/zone/resume/applications)    | C/C++软件开发                                                | 广    | 8/11 | 8/17 晚上7-9点笔试，根据一组ipv4地址，求对应子网掩码的长度(二进制1的个数)，不会 |
| 69   | 飞腾`0`                                                      | 软件研发                                                     | 成    | 8/11 | [问卷投递]()                                                 |
| 70   | 景嘉微                                                       | linux软件                                                    | 长    | 8/11 | 微信投递，8/16下午1面，7分钟结束，辣鸡                       |
| 71   | [友塔游戏](https://yotta-hr.com/zh/internal-recommendation?token=0cacb6883fe4a0dcbcb629fb14b5d5d4-769756-1377994766) | 游戏服务端开发                                               | 上    | 8/11 | 8/12笔试，8/17下午2点电话一面：堆排序；环状灯泡，如何操作全亮；一面挂`X` |
| 72   | [虾皮](https://app.mokahr.com/campus_apply/shopee/2962#/candidateHome/applications) | 后端开发                                                     | 上    | 8/11 |                                                              |
| 73   | [交银金科](https://i.51job.com/userset/my_apply.php?type=xy&lang=c) | 后端开发                                                     | 上    | 8/11 |                                                              |
| 74   | [宁德时代](https://app.mokahr.com/campus-recruitment/catlhr/73943#/candidateHome/applications) | 软件开发                                                     | 宁    | 8/11 | 8/11笔试`X`                                                  |
| 75   | [绿盟](https://app.mokahr.com/campus_apply/nsfocus/29118#/candidateHome/applications) | 研发C/C++                                                    | 成    | 8/11 |                                                              |
| 76   | [搜狐](https://app.mokahr.com/campus_apply/sohu/5682#/candidateHome/applications) | 后端开发Java                                                 | 成    | 8/11 |                                                              |
| 77   | [交通银行](https://job.bankcomm.com/getpersonalInfo.do?step=99) | 金融科技方向                                                 | 重    | 8/11 |                                                              |
| 78   | [吉利汽车](https://campus.geely.com/hcm-web/#/ucenter/cmine?type=request) | C++                                                          | 北    | 8/12 |                                                              |
| 79   | [快手](https://campus.kuaishou.cn/recruit/campus/e/#/campus/my-apply) | C++开发                                                      | 北    | 8/12 | 简历挂`X`                                                    |
| 80   | [中国系统](https://app.mokahr.com/campus_apply/cestc/7509#/candidateHome/applications)`0` | 后端开发                                                     | 成    | 8/12 |                                                              |
| 81   | [金山云](https://campus.ksyun.com/campus_apply/kingsoft/39364/#/candidateHome/applications)`0` | C/C++研发                                                    | 北    | 8/12 |                                                              |
| 82   | [thoughtworks](https://join.thoughtworks.cn/account?autoExpand) | SuperX计划                                                   | 成    | 8/12 |                                                              |
| 83   | [紫光展锐](https://wecruit.hotjob.cn/SU62964975bef57c6df7b40e20/mc/my/myDeliver) | 通信软件                                                     | 重    | 8/14 | 测评                                                         |
| 84   | [地平线](https://wecruit.hotjob.cn/SU62d914f10dcad43c775ec125/pb/account.html#/myDeliver)`0` | 应用软件                                                     | 北    | 8/14 |                                                              |
| 85   | [特斯拉]()                                                   | 软件开发Server                                               | 上    | 8/14 |                                                              |
| 86   | [海康威视](https://campushr.hikvision.com/myDelivery.html)   | 应用软件/测试开发                                            | 杭/重 | 8/14 | 测评，已笔试                                                 |
| 87   | [天翼云](https://wecruit.hotjob.cn/SU62b2ae672f9d24458d72f9cc/pb/account.html#/myDeliver) | 后端开发C++                                                  | 成    | 8/15 |                                                              |
| 88   | [百奥](https://app.mokahr.com/campus_apply/aobi/25016#/candidateHome/applications) | 游戏开发                                                     | 广    | 8/15 | **9月初笔试**                                                |
| 89   | 爱瑞无线                                                     | C/C++开发                                                    | 成    | 8/15 | 邮件投递                                                     |
| 90   | [京东](https://campus.jd.com/#/myDeliver?type=present)       | C++开发                                                      | 上    | 8/15 | **8/27晚上7-9点笔试**                                        |
| 91   | [亚马逊](https://account.amazon.jobs/zh-CN)                  | 软件开发                                                     | 上    | 8/15 |                                                              |
| 92   | 芯原股份                                                     | 软件                                                         | 成    | 8/15 | **8月28日（周日）上午10:00，8月27日下午一点看空宣，且笔试报名** |
| 93   | [B站](https://jobs.bilibili.com/campus/records)              | 服务端研发-B端                                               | 上    | 8/15 |                                                              |
| 94   | 上汽大通                                                     | 智能科技储备生                                               | 上    | 8/15 |                                                              |
| 95   | 客路客                                                       | 技术研发                                                     | 深    | 8/15 | 牛客投递                                                     |
| 96   | [游卡](https://app.mokahr.com/campus-recruitment/yokagames/41940#/candidateHome/applications) | 游戏服务端开发                                               | 杭    | 8/15 |                                                              |
| 97   | [乐狗](https://app.mokahr.com/campus_apply/legougames/6163#/candidateHome/applications) | 游戏服务端开发                                               | 成    | 8/15 | 8/20晚上笔试                                                 |
| 98   | [云骥智行](https://app.mokahr.com/campus-recruitment/pegasus/42891#/candidateHome/applications) | 软件开发                                                     | 上    | 8/15 | 已笔试                                                       |
| 99   | [冰川网络](https://app.mokahr.com/campus-recruitment/q1/37569#/candidateHome/applications) | C++开发                                                      | 深    | 8/15 | 08月19日 08:00笔试，已经完成                                 |
| 100  | [中兴](https://app.mokahr.com/campus-recruitment/zte/46903#/candidateHome/applications) | 软件开发                                                     | 重    | 8/16 | 8/19晚上7-9点笔试，方块消除、二进制钟表                      |
| 101  | [乐元素](https://app.mokahr.com/campus_apply/leyuansu/2357#/candidateHome/applications) | 游戏服务端开发                                               | 北    | 8/16 |                                                              |
| 102  | [鹰角网络](https://app.mokahr.com/campus_apply/hypergryph/26326?sourceToken=58b0eaa4804d0e9a762bd363f341577a#/candidateHome/applications) | 游戏服务端                                                   | 上    | 8/16 |                                                              |
| 103  | [星辉游戏](https://rastargame.zhiye.com/Portal/Apply/Index)  | 游戏服务端                                                   | 广    | 8/16 |                                                              |
| 104  | [garena](https://app.mokahr.com/campus_apply/garena/38200#/candidateHome/applications) | 游戏服务端开发                                               | 深    | 8/16 |                                                              |
| 105  | [神策数据](http://sensorsdata.zhiye.com/personal/deliveryRecord) | 后端                                                         | 成    | 8/16 |                                                              |
| 106  | [麒麟软件](https://kylinos.zhiye.com/Portal/Apply/Index)     | 服务器研发                                                   | 北    | 8/16 |                                                              |
| 107  | [依图](https://app.mokahr.com/campus_apply/yitu-inc/3700?sourceToken=9025307e66aeb3f3e622c56b369f00e5#/candidateHome/applications) | C++开发                                                      | 上    | 8/16 |                                                              |
| 108  | [龙图游戏](http://job.longtugame.com/t2/297/6241.html)       | 服务器开发                                                   | 北    | 8/16 |                                                              |
| 109  | [顺丰科技](http://campus.sf-express.com/#/personalCenter)    | C/C++开发                                                    | 深    | 8/16 |                                                              |
| 110  | [浪潮](https://wx64310b3064348282.hcmcloud.cn/recruit#/progress_detail?id=2335697&company_id=8) | 软件研发C/C++                                                | 郑    | 8/16 | 笔试                                                         |
| 111  | [汇川科技](https://inovance.zhiye.com/Portal/Apply/Index)    | 应用软件开发                                                 | 深    | 8/16 | 测评                                                         |
| 112  | [戴尔](https://dell.wd1.myworkdayjobs.com/External/login?redirect=%2Fen-US%2FExternal%2FuserHome) | 成都岗位？                                                   |       |      | 待投递                                                       |
| 113  | [亿联网络](http://yealink.zhiye.com/personal/deliveryRecord) | C++                                                          | 杭    | 8/17 | 测评                                                         |
| 114  | [博世](https://app.mokahr.com/campus-recruitment/bosch/73873#/candidateHome/applications) | 工具开发                                                     | 无    | 8/17 |                                                              |
| 115  | [奥比中光](http://job.orbbec.com.cn/personal/deliveryRecord) | 软件开发                                                     | 深    | 8/17 |                                                              |
| 116  | [添可智能](https://app.mokahr.com/campus_apply/tineco/36092#/candidateHome/applications) | 软件                                                         | 苏    | 8/17 |                                                              |
| 117  | 恒生电子                                                     | C/C++开发                                                    | 杭    | 8/17 | 9月开始流程                                                  |
| 118  | [广联达](https://app.mokahr.com/campus_apply/glodon/25288#/candidateHome/applications) | C++开发                                                      | 西    | 8/18 |                                                              |
| 119  | [贝壳找房](https://ke.zhiye.com/Portal/Apply/Index)          | C++开发                                                      | 北    | 8/18 |                                                              |
| 120  | [小米](https://app.mokahr.com/campus_apply/xiaomi/47097#/candidateHome/applications) | 软件开发C/C++                                                | 北    | 8/18 | 测评，简历挂`X`                                              |
| 121  | [创维](https://wecruit.hotjob.cn/SU62e24840bef57c63469fec10/pb/account.html#/myDeliver) | 软件C/C++                                                    | 深    | 8/18 |                                                              |
| 122  | 永航科技                                                     | C++服务器开发                                                | 北    | 8/18 | 牛客投递                                                     |
| 123  | [奇瑞控股](http://cheryholding.zhiye.com/personal/deliveryRecord) | 软件开发                                                     | 芜    | 8/18 |                                                              |
| 124  | 联咏科技                                                     | 软件开发                                                     | 西    | 8/18 | 51job投递                                                    |
| 125  | [网易互联网](https://campus.163.com/app/personal/apply)      | C++开发                                                      | 杭    | 8/18 | 8/20笔试                                                     |
| 126  | [华勤集团](https://app.mokahr.com/campus-recruitment/hq/44757#/candidateHome/applications) | 驱动开发C++                                                  | 无    | 8/18 | 已在线笔试                                                   |
| 127  | [度小满](https://app.mokahr.com/campus-recruitment/duxiaoman/74050#/candidateHome/applications) | 后端开发                                                     | 北    | 8/18 |                                                              |
| 128  | [tap4fun](https://campus.tap4fun.com/campus_apply/tap4fun/291/#/candidateHome/applications) | 服务器开发                                                   | 成    | 8/19 |                                                              |
| 129  | [吉比特](https://hr.g-bits.com/web/index.html#/center-web/recruit-query) | 游戏研发                                                     | 广    | 8/19 | **待笔试**，计算机网络传输的性能优化，减少卡顿               |
| 130  | [沐瞳](https://moonton.jobs.feishu.cn/campus/position/application) | 服务器C++                                                    | 上    | 8/19 |                                                              |
| 131  | 网龙                                                         | 游戏开发C++                                                  | 福    | 8/19 | 51job投递，成都有开发岗？                                    |
| 132  | 紫龙游戏                                                     | 游戏服务端开发                                               | 上    | 8/19 | 邮箱投递                                                     |
| 133  | [叠纸游戏]()                                                 | 游戏服务器开发                                               | 上    | 8/19 |                                                              |
| 134  | [好未来](https://neitui-campus.zhiyinlou.com/applyRecord)    | 服务端开发C++                                                | 北    | 8/19 |                                                              |
| 135  | 帆软                                                         | 产品研发-后端                                                | 成    | 8/19 | 微信可查进度，简历挂`X`                                      |
| 136  | [经纬恒润](https://wecruit.hotjob.cn/SU62a93e760dcad45229a827cc/pb/account.html#/myDeliver) | 智能汽车开发                                                 | 重    | 8/19 | **08-31 10:00面试**                                          |
| 138  | [极智嘉](https://app.mokahr.com/campus_apply/geekplus/77928#/candidateHome/applications) | 软件开发                                                     | 深    | 8/20 |                                                              |
| 139  | 云和恩墨                                                     | 数据库内核C++                                                | 成    | 8/20 |                                                              |
| 140  | [柏楚电子](https://fscut.zhiye.com/Portal/Apply/Index)       | 软件开发/C++                                                 | 上    | 8/20 |                                                              |
| 141  | [智加科技](https://app.mokahr.com/social-recruitment/plus/73958#/job/d2786821-c6bb-4347-b58e-636d031bca61) | 自动驾驶软件                                                 | 苏    | 8/20 |                                                              |
| 142  | [华芯巨数](https://app.mokahr.com/campus_apply/huaxinjushu/36809#/candidateHome/applications) | 软件开发                                                     | 杭    | 8/20 |                                                              |
| 143  | 行深智能                                                     | C++开发                                                      | 长    | 8/20 |                                                              |
| 144  | [图森](https://app.mokahr.com/campus_apply/tusenweilai/35932?recommendCode=DSSw7KvB#/candidateHome/applications) | 软件研发                                                     | 北    | 8/20 | 简历挂`X`                                                    |
| 145  | [韶音](https://app.mokahr.com/campus_apply/aftershokzhr/36940?recommendCode=DS79KPRu#/candidateHome/applications) | 软件开发                                                     | 深    | 8/20 |                                                              |
| 146  | [万得](https://www.wind.com.cn/newsite/recruit.html?positionType=9002) | 软件研发-C++                                                 | 苏    | 8/20 |                                                              |
| 147  | [卡方科技](https://jinshuju.net/f/B9Oa9g)                    | C++                                                          | 杭    | 8/20 | 问卷投递                                                     |
| 148  | [众星](https://app.mokahr.com/campus_apply/aistar/77986?recommendCode=DSCYyN5e#/candidateHome/applications) | 后端开发                                                     | 深    | 8/20 |                                                              |
| 149  | [商米](https://app.mokahr.com/campus_apply/sunmi/4414?recommendCode=DSfQW1q2#/candidateHome/applications) | 后端开发                                                     | 上    | 8/20 |                                                              |
| 150  | [晶科能源](https://app.mokahr.com/campus_apply/jinkosolar/41896?recommendCode=DSpkghvq#/candidateHome/applications) | IT岗                                                         | 四    | 8/20 |                                                              |
| 151  | [三七互娱](https://app.mokahr.com/campus_apply/37/25238?recommendCode=DSAHRdSb#/candidateHome/applications) | 后端开发                                                     | 广    | 8/20 |                                                              |
| 152  | [光娱](https://app.mokahr.com/campus_apply/guangyvgame/7466?recommendCode=DSjJf852#/candidateHome/applications) | 服务端开发                                                   | 广    | 8/20 |                                                              |
| 153  | [优特科技](http://utpower.zhiye.com/personal/deliveryRecord) | 嵌入式                                                       | 珠    | 8/20 |                                                              |
| 154  | [东软](https://wxservice.neusoft.com/talent/post?method=postDetailView&detail=10263568612) | 软件开发                                                     | 重    | 8/20 |                                                              |
| 155  | [小鹏](https://app.mokahr.com/campus_apply/xiaopeng/22#/candidateHome/applications) | 自动驾驶软件开发/C++                                         | 广    | 8/20 |                                                              |
| 156  | [招商银行](https://career.cloud.cmbchina.com/index.html#jobList?id=96574F8D-C7ED-4772-AE7C-BAC896D190C1) | 待投递                                                       |       |      |                                                              |
| 157  | [先导](http://leadchina.zhiye.com/personal/deliveryRecord)   | 软件研发                                                     | 无    | 8/21 |                                                              |
| 158  | [高途](https://app.mokahr.com/campus_apply/bjhl/24358?recommendCode=QTs53Z#/candidateHome/applications) | C++开发                                                      | 北    | 8/21 |                                                              |
| 159  | [美的](https://careers.midea.com/schoolOut/apply)            | C++开发                                                      | 佛    | 8/21 | 已经笔试，定义的sort(string str)，[有序链表转换为平衡搜索树](https://leetcode.cn/problems/convert-sorted-list-to-binary-search-tree/submissions/),==ac== |
| 160  | [海信](http://hisense.zhiye.com/Portal/Apply/Index)          | 软件开发                                                     | 青    | 8/21 |                                                              |
| 161  | [精雕](https://job.jingdiao.com/resume/edit)                 | 软件研发                                                     | 西    | 8/22 |                                                              |
| 162  | [迅雷](https://campus.xunlei.com/campus_apply/xunlei/26600/#/candidateHome/applications) | 跨平台C++                                                    | 深    | 8/22 |                                                              |
| 163  | [中国电信]()                                                 | 研发                                                         | 重    | 8/23 | 51job投递，测评                                              |
| 164  | [思科](http://2023.yingjiesheng.com/cisco/)                  | 软件开发                                                     | 上    | 8/22 | 51job投递                                                    |
| 165  | [安克创新](https://anker-in.jobs.feishu.cn/referral/campus/position/application?token=NTsxNjYwNTU1Nzc4NTY2OzcxMTUyODg5NTczMjYzNjA1Nzc7NzEzMjAzMjY0ODA3NjE2NzQzMg) | 软件/后台开发                                                | 深    | 8/22 |                                                              |
| 166  | [亚控科技](https://app.mokahr.com/campus-recruitment/wellintech/72020#/job/122845b6-8dbb-42bc-9cb6-91a13cc4c665/campus_apply/thanks?jobId=122845b6-8dbb-42bc-9cb6-91a13cc4c665&codeType=2&isRecommendation=false&applyInfo%5BcampusSiteId%5D=24198&applyInfo%5BaimWorkCity%5D=%E6%88%90%E9%83%BD%E5%B8%82&applyInfo%5BrecommendCode%5D=DSVWPsAv&candidateName=%E5%88%98%E6%8C%AF%E6%A3%AE&candidateId=363083931) | 软件开发C++                                                  | 成    | 8/22 |                                                              |
| 167  | [携程](https://campus.ctrip.com/#/candidateHome/applications) | 后端开发java                                                 | 上    | 8/22 |                                                              |
| 168  | [小红书](https://job.xiaohongshu.com/record/campus)          | 后端开发/C++                                                 | 北    | 8/22 |                                                              |
| 169  | [字节](https://jobs.bytedance.com/campus/position/application?spread=ZHMP9K6) | 后端开发-基础架构                                            | 成    | 8/24 |                                                              |
| 170  | [腾讯音乐]()                                                 |                                                              |       |      |                                                              |
| 171  | [阿里]()                                                     |                                                              |       |      |                                                              |
| 172  | [六方云](https://app.mokahr.com/campus_apply/6cloudtech/29141?recommendCode=DSG17xgk#/candidateHome/applications) | C++开发                                                      | 西    | 8/22 |                                                              |
| 173  | [虎牙](https://app.mokahr.com/campus_apply/huya/4112#/candidateHome/applications) | C++后台开发                                                  | 广    | 8/23 |                                                              |
| 174  | oppo                                                         |                                                              |       |      |                                                              |
| 175  | vivo                                                         |                                                              |       |      |                                                              |
| 176  | 菜鸟                                                         |                                                              |       |      |                                                              |
| 177  | 中金                                                         | 软件开发                                                     | 苏    | 8/23 | 微信内推投递                                                 |
| 178  | [新浪微博]()                                                 |                                                              |       |      |                                                              |
| 179  | [格力](https://gree.zhiye.com/Portal/Apply/Index)            | 应用软件                                                     | 珠    | 8/23 | 测评                                                         |
| 180  | [祖龙](https://campus.zulong.com/campus_apply/zulong/25158/#/candidateHome/applications) | C++游戏服务器开发                                            | 北    | 8/23 |                                                              |
| 181  | 航天新通                                                     | C/C++开发                                                    | 重    | 8/24 |                                                              |
| 182  | [欧克云链](https://app.mokahr.com/campus_apply/okgroup/72016?sourceToken=a989bbc000c2701e9b5b2112876949d9#/candidateHome/applications) | C++开发                                                      | 北    | 8/24 |                                                              |
| 183  | [tplink](https://hr.tp-link.com.cn/socialDelivery)           | 软件-后端                                                    | 成    | 8/24 |                                                              |

#### 3、笔试记录：

1. 判断一个点point是否在一个多边形中，过该点作任意一条射线，与多边形的交点为偶数，则在外面，若为奇数，则在内部——中望

2. 反转字符串、[445两个链表相加](https://leetcode.cn/problems/lMSNwu/)、3最长无重复字串、7整数翻转————北云

3. 趋势科技：占位符的替换，思路正确，但是没通过，[牛客收藏有题解](https://www.nowcoder.com/discuss/1006061)，记得看一下

4. [微软](https://www.nowcoder.com/discuss/1006388?type=all&order=recall&pos=&page=2&ncTraceId=&channel=-1&source_id=search_all_nctrack&gio_id=93D2E04A24FE4FB35F02D9F2DD8C91C0-1659948694686)：给定数组A,B，数字B，A[i],B[i]分别表示病人i想要看病的最佳时刻，B表示医生的可以接诊的时刻1-B，问`是否`所有病人都能在自己想要的时刻看病。

   - 先拓扑排序筛所有每个时刻只有一个病人的安排掉，剩下的成环，累加病人数和时间数，如果时间数>病人数，则可以安排。
   - 或者使用并查集

5. 科大讯飞

   - 给4个点point，求围城凸四边形的面积——我的解法，划分为两个三角形，三角形面积公式`area = sqrt(s(s-a)(s-b)(s-c))`,其中a,b,c为边长,利用两点之间距离求出，s=(a+b+c)/2；但最终不知道为什么无法通过；
   - 在给定字符串str中寻找有多少个的子字符串`iflytek`，可以不连续，但是顺序要固定，我的思路:使用dfs，但超时了，只通过了66%。[leetcode 115原题——二维动态规划](https://leetcode.cn/problems/distinct-subsequences/)

6. 猿辅导——vs微软笔试中记录有。内存泄漏OOM如何排查
   ...
   - [解决办法](https://blog.csdn.net/yrk0556/article/details/88040954)

     <img src="myassets/image-20220807221641110.png" alt="image-20220807221641110" style="zoom: 50%;" />

   - zoom——求树的权值

     > 树中，一个节点的权值定义为：从根节点(代号为1)到该节点路径上的红蓝节点个数之差的绝对值，求树中所有节点的权值之和
     >
     > 输入参数n，表示树有n个节点
     >
     > 字符串color，表示n个节点对应的颜色R红色/B蓝色
     >
     > 接下来的n-1行，每行两个整数n1 n2， 表示节点n1与n2之间连接
     >
     > ```C++
     > #include <bits/stdc++.h> 
     > using namespace std;
     > // 将一些变量定义为全局，方便使用，acm模式下，需要dfs很方便
     > int n;
     > string color;
     > vector<vector<int>> g;
     > int ans = 0;
     > 
     > void dfs(int cur, int blue, int red, int curRoot) {
     > 	if (color[cur] == 'R') red++;
     > 	else blue++;
     > 
     > 	ans += abs(red - blue); // 当前路径（根节点root到cur,注意curRoot只是cur的父节点，而不是整棵树的root）上的红蓝节点之差绝对值    
     > 
     >     for (auto x : g[cur]) {
     >       if (x != curRoot) { // 保证往左右孩子递归
     >           dfs(x, blue, red, cur); // 维护blue，red向下递归
     >       }
     >     }
     > }
     > 
     ...
     > 	cin >> n;
     >     cin >> color;
     >     g.resize(n); // 根据输入，初始化临接表
     >     int n1, n2;
     >     for (int i = 0; i < n - 1; i++) { // 根据输入建表
     >       cin >> n1 >> n2;
   ...
   - 宁德时代笔试：[leetcode767题](https://leetcode.cn/problems/reorganize-string/submissions/)，[85题-输出最大矩形的上/下/左/右边界]()
   
   - 美团8/13笔试
   
     - 题1、送外卖订单不超时，最少需要几次魔法——先排序，再贪心
     - 题4、nums，i < j < k,有几种nums[i]-nums[j] = 2 * nums[j] - nums[k]
       - 两个for循环+map
       - 或者一个for循环+双指针，O(nlogn)
     - 题5，给定n个二叉树节点，第K个节点，2K>n,没有左孩子；2K+1》n没有右孩子，求从根节点到叶子节点的最大路径和——递归，cur-》val + max(dfs(2k, nums), dfs(2k + 1) , nums); 
   
   - 乐狗游戏8/20笔试
   
     - 1，游戏双方互相攻击
     - 2,给定字符串str，包含字母和空格，给定每行得窗口得大小，使得字符串按照一定规则在若干行窗口中填充，最后输出最后一行的内容，若不能填充，输出"error"；
     - 二维数组中，给定生命值hp，输出入口-2到出口-3的最大剩余生命值，其中0-9表示经过此处消耗的生命，-1表示障碍物不能通过，若无法到达出口，输出-1————回溯通过54%，牛客上使用二维dp，记录到达某点i，j所剩余的能量，每个点保持较大值，最后输出dp[outx] [outy]
...
>
> [字典树`TrieTree`图文详解](https://blog.csdn.net/qq_49688477/article/details/118879270?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522165959982816781683974157%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=165959982816781683974157&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~top_positive~default-1-118879270-null-null.142^v39^pc_rank_34_2&utm_term=%E5%AD%97%E5%85%B8%E6%A0%91&spm=1018.2226.3001.4187)————海量单词库下根据某个单词作为前缀实现模糊匹配查询(元戎一面)
>
> 堆排序
...
| [堆排序](https://blog.csdn.net/weixin_43142797/article/details/105772261?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522165969029816781432991673%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=165969029816781432991673&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~baidu_landing_v2~default-3-105772261-null-null.142^v39^pc_rank_34_2,185^v2^control&utm_term=%E5%A0%86%E6%8E%92%E5%BA%8FC%2B%2B&spm=1018.2226.3001.4187) | O(n*log2n)     | O(n*log2n)     | **O(1)**   | 不稳定               |
...
[剑指offer46——把数字翻译成字符串](https://leetcode.cn/problems/ba-shu-zi-fan-yi-cheng-zi-fu-chuan-lcof/)——**既可以回溯，又可以动态规划**

讲一下代码随想录的**回溯5部曲、动态规划5步曲**、二叉树（递归与迭代）、链表、字符串匹配、数组、图、滑动窗口、贪心算法
...
- **开放定址法：**遇到哈希冲突时，去寻找一个新的空闲的哈希地址
  ...
  - 线性探测法：当需要存放值的位置被占了，就往后面一直加1并对m取模直到存在一个空余的地址供我们存放值，取模是为了保证找到的位置在0~m-1的有效空间之中。

    `公式：h(x)=(Hash(x)+i)mod (Hashtable.length);（i会逐渐递增加1）`

  - 平方探测法（二次探测）:当需要存放值的位置被占了，会前后寻找而不是单独方向的寻找。

    `公式：h(x)=(Hash(x) +i)mod (Hashtable.length);（i依次为 +(i^2) 和 -(i^2)）`

    <img src="https://img-blog.csdnimg.cn/20210709202911464.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQ4MjQxNTY0,size_16,color_FFFFFF,t_70" alt="img" style="zoom:50%;" />

- **再哈希法**：同时构造多个不同的哈希函数，等发生哈希冲突时就使用第二个、第三个……等其他的哈希函数计算地址，直到不发生冲突为止。虽然不易发生聚集，但是增加了计算时间。

- **链地址法：**将所有哈希地址相同的记录都链接在同一链表中。

  <img src="https://img-blog.csdnimg.cn/20210709221827318.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQ4MjQxNTY0,size_16,color_FFFFFF,t_70" alt="img" style="zoom:50%;" />

- **建立公共溢出区**：将哈希表分为基本表和溢出表，将发生冲突的都存放在溢出表中。

### 5、set、unordered_set存储自定义的数据结构要怎么做？

- set 、map底层是[红黑树](https://so.csdn.net/so/search?q=红黑树&spm=1001.2101.3001.7020)，set/map这类容器是自动排序的，基本类型有默认的排序规则，但是自定义的没有，因此我们需要重载<运算符，相当于**给自定义类型一个排序准则**。

  - 使用[lambda](https://so.csdn.net/so/search?q=lambda&spm=1001.2101.3001.7020)表达式

  - [set重载原有的比较方式`<`](https://segmentfault.com/a/1190000022656413)
...
- unordered_开头的，底层哈希表，如果 unordered_set 容器中存储的元素为自定义的数据类型**，则默认的哈希函数` hash<key>` 以及比较函数 `equal_to<key>` 将不再适用，只能自己设计适用该类型的哈希函数和比较函数**，并显式传递给 `Hash `参数和 `Pred `参数。

  - unordered_set 容器的类模板定义如下：

  - ```C++
    template < class Key,            //容器中存储元素的类型
               class Hash = hash<Key>,    //确定元素存储位置所用的哈希函数,默认哈希函数 hash<Key> 只适用于基本数据类型（包括 string 类型），而不适用于自定义的结构体或者类。
               class Pred = equal_to<Key>,   //判断各个元素是否相等所用的函数,仅支持可直接用 == 运算符做比较的数据类型。
...
>  ==1、[继承](https://blog.csdn.net/qq_51004011/article/details/125555772)==
>
...
> 
>C++有两种多态，称为**动态多态（运行期多态）和静态多态（编译器多态）**，静多态主要是通过模板、重写来实现，而动多态是通过虚函数来实现的。即在基类中存在虚函数（一般为纯虚函数）子类通过重载这些接口，使用基类的指针或者引用指向子类的对象，就可以调用子类对应的函数，动多态的函数调用机制是执行器期才能确定的，所以他是动态的。 
> 
...
>  
>封装性实际上是由编译器去识别关键字public、private和protected来实现的，体现在类的成员可以有私有成员(private)，保护成员(protected)，公有成员(public)。
>  
...
>
> - 静态成员函数，静态函数由类名(::)(或对象名.)调用,但静态函数不传递this指针,不识别对象个体,所以通常用来对类的静态数据成员操作
...
>    - **const修饰指针变量*及引用变量&**  
>
>      常量指针，如果const位于星*的左侧，则const就是用来修饰指针所指向的变量，即指针指向为常量
>
>      指针常量，如果const位于星号的右侧，const就是修饰指针本身，即指针本身是常量。   
>
> 2. const应用到函数中
>
>    - **作为参数的const修饰符**
...
>    - **const数据成员**
>
>      其的初始化只能在类构造函数的初始化表中进行,不能在类声明中初始化const数据成员。
>
>    - **类中的const成员函数：**
>
>      `A fun4()const;` 其意义上是不能修改所在类的的任何变量。
>
> 4. **const修饰类对象，定义常量对象** 
...
> `常量指针const int *a`，**指针指向的内容是一个常量**，可以改变指向的地址，只要新地址里面也是常量就好。（小明原来住在六舍356，后来搬到357，不管是356还是357，里面住的都是小明）
>
> ```c++
> int a = 10, b = 20;
> const int *p = &a;
...
### 17-1.智能指针`share_ptr`怎么实现的？是线程安全的吗？
...
2. `shared_ptr`的实现机制是**==在拷⻉构造时使⽤同⼀份引⽤计数==**  
   ...
   >
   > - shared_ptr是一种shared_ptr是**引用计数型**智能指针，几乎所有的实现都采用==**在堆上**==放个计数器。shared_ptr的作用有如内指针，但会记录有多少个tr1::shared_ptrs共同指向一个对象。这便是所谓的引用计数（reference counting）。一旦最后一个这样的指针被销毁，也就是一旦某个对象的引用计数变为0，这个对象会被自动删除。这在非环形数据结构中防止资源泄露很有帮助。
   >
...
### 17-2、[unique_ptr独占型智能指针详解](https://blog.csdn.net/qq_38410730/article/details/105725663?utm_medium=distribute.pc_relevant.none-task-blog-2~default~baidujs_baidulandingword~default-4-105725663-blog-121822361.pc_relevant_multi_platform_whitelistv1_exp2&spm=1001.2101.3001.4242.3&utm_relevant_index=7)

- unique_ptr 对对象独有管理,无法复制,共享,值传递,可以使用move语义来转移控制权.
- 当智能指针**作为函数的参数或者返回值**时，
  - 不要传递shared_ptr本身，而是用原始指针。因为会有性能损失，原子操作的自增自减等。
  - 当表示所有权的转移时，用unique_ptr作为函数参数。
  - [unique_ptr是没有拷贝构造、拷贝赋值，==但支持move构造/赋值的，unique_ptr对象可以被函数返回==](https://blog.csdn.net/booirror/article/details/44455293?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522165968747716781790763216%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=165968747716781790763216&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduend~default-2-44455293-null-null.142^v39^pc_rank_34_2,185^v2^control&utm_term=unique_ptr%E4%BD%9C%E4%B8%BA%E8%BF%94%E5%9B%9E%E5%80%BC&spm=1018.2226.3001.4187)
...
> [数组指针++与指针数组++的区别](https://blog.csdn.net/weixin_50212958/article/details/109264469?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522165960073616781432997365%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=165960073616781432997365&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~top_click~default-2-109264469-null-null.142^v39^pc_rank_34_2&utm_term=%E6%95%B0%E7%BB%84%E6%8C%87%E9%92%88&spm=1018.2226.3001.4187)
>
> 需要明确一个[优先级](https://so.csdn.net/so/search?q=优先级&spm=1001.2101.3001.7020)顺序：`() > [] > *`，所以：
>
> `int (*p2)[n]`：**根据优先级，先看括号内，则p2是一个指针**，这个指针指向一个[一维数组](https://so.csdn.net/so/search?q=一维数组&spm=1001.2101.3001.7020)，数组长度为n，这是“数组的指针”，即**数组指针**；对数组指针来说，首先它是一个指针，它指向一个数组，也就是说它是指向数组的指针，在 32 位系统下永远占 4 字节，至于它指向的数组占多少字节，这个不能够确定，要看具体情况
>
> ![img](https://img-blog.csdnimg.cn/20190917164330539.jpg)
>
> `int *p1[n]`：**根据优先级，先看[]，则p1是一个数组**，再结合*，这个数组的元素是指针类型，共n个元素，这是“指针的数组”，即**指针数组**。对指针数组来说，首先它是一个数组，数组的元素都是指针，也就是说该数组存储的是指针，数组占多少个字节由数组本身决定；
>
> ​                   ![img](https://img-blog.csdnimg.cn/20190917164233526.jpg) 图1
>
> 数组指针和指针数组的区别；
>
> - 数组指针`p2++` ；它是指向数组的指针,**偏移整个数组的字节**，例如；数组有5个整型数据，那么一个整型变量占4个字节，那数组指针`p2++` 就偏移20个字节。&数组名表示的是取出整个数组的地址，而不是首元素地址，所以它+1步长跳过整个数组
> - 指针数组`p1`++；**偏移一个数组元素的字节**。



### 24、`const volatile int i=0`

>  提问：i在常量区吗，还是不属于任何内存分区？
>
> 分析如下：
>
> 首先，这个变量i被const修饰，说明它是一个只读变量，由于**又被volatile修饰，说明，该变量i是一个只读变量，当这个变量作为左值时，不让编译器做任何优化，而是直接去内存中取值。**
> 该情况适合多线程的情况。
...
>
> 所以这里的i的属性是在本程序中，i应该是只读的，不应该被修改的，但是它也可能被外部的例如中断，共享的线程通过某种方式修改，所以这里也不该被编译器优化，虽然它是只读的不该被修改的，但是它还是会改变，我们在本程序中使用的时候，还是要每次都去它所在的内存中读它的值，这是一种“双重保险”。
>
...
> [cmake快速入门](https://blog.csdn.net/kai_zone/article/details/82656964?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522165960528416782388083676%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=165960528416782388083676&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~top_positive~default-2-82656964-null-null.142^v39^pc_rank_34_2&utm_term=cmake&spm=1018.2226.3001.4187)

### 26、C++为什么不能通过函数返回值区分函数重载？

- 根本原因：**编译过后的符号表中函数信息**仅包括**函数名和参数列表信息**，所以参数类型不同可以重载，编译器根据参数为每个重载函数产生不同的内部标识符，而**无法重载仅按返回值类型区分的函数**。
...
- 对于空类，**声明**时，编译器不会生成任何的成员函数，只会生成**1个字节的占位符**
  ...
  sizeof(Empty) = 1;
  sizeof(A) = 1;
  sizeof(B) = 8(64位系统，虚函数指针的大小)
  ```

- 当空类**定义一个实例对象`Empty e;`**时，编译器会**自动生成6个成员函数**，等价于
...
:star:https://www.zhihu.com/question/420641226
...
>
> [Linux高性能I/O框架库Libevent介绍](https://blog.csdn.net/weixin_52622200/article/details/119839453?spm=1001.2101.3001.6650.15&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7Edefault-15-119839453-blog-80213533.pc_relevant_multi_platform_whitelistv3&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7Edefault-15-119839453-blog-80213533.pc_relevant_multi_platform_whitelistv3&utm_relevant_index=20)
>
> [libevent 事件的优先级队列——实现的原理与过程](https://blog.csdn.net/jackywgw/article/details/78097551)

### 5、Json与Protobuf

>[轻量级的数据交互格式_——JSON 基本使用](https://blog.csdn.net/qq_41684621/article/details/113851644?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522165960605416782248516635%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=165960605416782248516635&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~top_positive~default-1-113851644-null-null.142^v39^pc_rank_34_2&utm_term=Json&spm=1018.2226.3001.4187)
>
> [结构化数据的序列化方法——Protobuf 详解](https://blog.csdn.net/weixin_42018112/article/details/89633837)
>
>[XML]()
...
```C++
槽(slot)的意思就是对收到信号（signal）的处理方式（窗口关闭，隐藏之类的）
...
<img src="https://img-blog.csdnimg.cn/20201106020908253.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2FieXNzX21pcmFjbGU=,size_16,color_FFFFFF,t_70#pic_center" alt="在这里插入图片描述" style="zoom: 67%;" />
...
> [select、poll、epoll介绍与区别](https://www.cnblogs.com/zyy1688/p/10736558.html)
>
> [poll函数](https://blog.csdn.net/lianghe_work/article/details/46534029?spm=1001.2101.3001.6650.1&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7Edefault-1-46534029-blog-82743681.pc_relevant_aa_2&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7Edefault-1-46534029-blog-82743681.pc_relevant_aa_2&utm_relevant_index=2)
>
...
### 2、OSI 的七层模型分别是？TCP/IP五层模型？

> [帅地玩编程网站版本](https://www.iamshuaidi.com/3612.html)
>
> :book:从下至上：物理层、数据链路层、网络层、传输层、会话层、表示层，**各层功能如下：**
>
> <img src="myassets/image-20220808104713350.png" alt="image-20220808104713350" style="zoom:80%;" />
>
> <img src="myassets/image-20220807165554252.png" alt="image-20220807165554252" style="zoom: 50%;" />
>
> ![image-20220709104746158](C:\Users\Admin003\AppData\Roaming\Typora\typora-user-images\image-20220709104746158.png)

<img src="https://image.iamshuaidi.com/picture/image-20210607144015234.png" alt="img" style="zoom: 50%;" />

TCP/IP五层模型：应用层、传输层、网络层、数据链路层、物理层。各层功能如下：

- **应用层**：为应用程序提供交互服务。在互联网中的应用层协议很多，如域名系统DNS、HTTP协议、SMTP协议等。——报文
- **传输层**：负责向两台主机进程之间的通信提供数据传输服务。传输层的协议主要有传输控制协议TCP和用户数据协议UDP。——段
- **网络层**：选择合适的路由和交换结点，确保数据及时传送。主要包括IP协议。——数据包
- **数据链路层**：在两个相邻节点之间传送数据时，**数据链路层将网络层交下来的 IP 数据报组装成帧**，在两个相邻节点间的链路上传送**帧**。
- **物理层**：实现相邻节点间**比特流**的透明传输，尽可能屏蔽传输介质和物理设备的差异。

### 3、TCP头部中包含哪些信息？

<img src="https://mmbiz.qpic.cn/mmbiz_png/g6WfVFoiaM5RDBxVUE6n2IgQTbicicPK9dzm9X0k1tb2GacJ6JqavsG6y7nCficnJxl850RE4WdDLpGRZufagaSp1g/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1" alt="图片" style="zoom: 67%;" />

![image-20220709105918291](C:\Users\Admin003\AppData\Roaming\Typora\typora-user-images\image-20220709105918291.png)

TCP头部包含以下信息：

- 16位源端口号（发送端），16位目的端口号（接收端）

- ==序号==（32bit）：传输方向上字节流的字节编号。初始时序号会被设置⼀个**随机的初始值（ISN）**，之后每次发送数据时，**序号值 = ISN + 数据在整个字节流中的偏移**。假设A -> B且ISN = 1024，第⼀段数据512字节已经
  到B，则第二段数据发送时序号为1024 + 512。**用于解决网络包乱序问题**。
- ==确认号==（32bit）：接收方对发送方TCP报文段的响应，其值是收到的**序号值 + 1**
...
- ==标志位==（6bit）：
  ...
  - `SYN`：表示请求建立⼀个连接（连接报文段）。
  - `FIN`：表示关闭连接（断开报文段）。
- ==窗⼝==（16bit）：接收窗口。用于告知对方（发送方）本方的缓冲还能接收多少字节数据。用解决流量控制。
- 校验和（16bit）：接收端用[循环冗余校验`CRC`）码](https://www.jianshu.com/p/7f4fd7f62de2)检验整个报文段有无损坏  
...
- HTTP请求由**请求行、请求头部、空行和请求体**四个部分组成。
  ...
  - **请求头**：格式为“属性名:属性值”，服务端根据请求头获取客户端的信息，主要有cookie、host、connection、accept-language、accept-encoding、user-agent。
    - `Accept`作用：浏览器端可以接受的媒体类型 例：Accept ：text/html 
    - `Accept-Encoding`作用： 浏览器申明自己接收的编码方法，通常指定压缩方法，是否支持压缩，支持什么压缩方法（gzip，deflate）
    - `Accept-Language` 作用：浏览器申明自己接收的语言。 例：Accept-Language: en-us
    - `Connection`例如：`Connection: keep-alive`  当一个网页打开完成后，客户端和服务器之间用于传输HTTP数据的TCP连接不会关闭，如果客户端再次访问这个服务器上的网页，会继续使用这一条已经建立的连接
    - `Host`（发送请求时，该报头域是必需的） **作用: 请求报头域主要用于指定`被请求资源的Internet主机和端口号`，它通常从HTTP URL中提取出来的**
    - `Referer` 作用：当浏览器向web服务器发送请求的时候，一般会带上Referer，告诉服务器我是从哪个页面链接过来的
    - `User-Agent` 作用：告诉HTTP服务器， 客户端使用的[操作系统](http://lib.csdn.net/base/operatingsystem)和浏览器的名称和版本**.
  - **空行**
  - **请求体**：用户的请求数据如用户名，密码等。

  - 请求报文示例

    <img src="myassets/image-20220809114545726.png" alt="image-20220809114545726" style="zoom:50%;" />
...
- HTTP响应也由四个部分组成，分别是：**状态行、响应头、空行和响应体**。
  ...
  - 响应报文示例
    ...
    <img src="myassets/image-20220809114728810.png" alt="image-20220809114728810" style="zoom:50%;" />
...
>
> Expire 其指定了一个日期/时间， 在这个日期/时间之后，HTTP响应被认为是过时的。但是它本身是一个`HTTP1.0`标准下的字段，在`HTTP1.1中`所以如果请求中还有一个置了 “max-age” 或者 “s-max-age” 指令的ache1-Control响应头，那么 Expires 头就会被忽略，优先处理max-age指令。
>
> `Cache-Control通用消息头`用于在http 请求和响应中通过指定指令来实现缓存机制。其常用的几个取值有：
>
> private：客户端可以缓存
>
...
>  解决方式：
>
>  1. **格式化数据：每条数据有固定的格式（开始符，结束符）**，这种方法简单易行，**但是**选择开始符和结束符时一定要确保每条数据的内部不包含开始符和结束符。
...
- 首先，TCP的连接是==基于三次握手，而断开则是四次挥手。确保端到端连接和断开的可靠性==。
- 其次，TCP的可靠性，还体现在==有状态==;TCP会记录哪些数据发送了，哪些数据被接受了，哪些没有被接受，并且保证==数据包按序到达==，保证数据传输不出差错。
...
- ==目的是==`接收方通过TCP头窗口字段告知发送方本方可接收的最大数据量，用以解决发送速率过快导致接收方不能接收的问题`。所以流量控制是**点对点**控制。
- TCP是双工协议，双方可以同时通信，所以发送方、接收方各自维护一个发送窗和接收窗。
  - ==发送窗==：用来限制发送方可以发送的数据大小，其中`发送窗口的大小由接收端返回的TCP报文段中窗口字段来控制`，接收方通过此字段告知发送方自己的缓冲（受系统、硬件等限制）大小。
  - ==接收窗==：用来标记可以接收的数据大小。
- TCP是流数据
  - ==发送出去的数据流==可以被分为以下四部分：已发送且被确认部分 | 已发送未被确认部分 | 未发送但可发送部分 | 不可发送部分，其中`发送窗 = 已发送未确认部分 + 未发但可发送部分`。
  - ==接收到的数据流==可分为：已接收 | 未接收但准备接收 | 未接收不准备接收。`接收窗 = 未接收但准备接收部分`
- 窗口的移动：发送窗内数据**只有当接收到接收端，某段发送数据的ACK响应时**才移动发送窗，左边缘紧贴刚被确认的数据。接收窗也**只有接收到数据且最左侧连续时**才移动接收窗口。  

### 9、拥塞控制算法

TCP四大拥塞控制算法总结？（极其重要）  ——————拓跋阿秀的八股文计算机网络==79==
...
- 流量控制**属于通信双方协商**；拥塞控制涉及**通信链路全局**，拥塞控制是个庞大的问题，因为考虑到了整个网络。对于拥塞控制很难有最优解
- 窗口大小——流量控制需要通信双方各维护⼀个发送窗、⼀个接收窗，对任意一方，接收窗大小由自身决定，**发送窗大小由接收方响应的TCP报文段中窗口值确定**；拥塞控制的拥塞窗口大小变化**由试探性发送一定数据量数据探查网络状况后而自适应调整**。
...
> :book: 概念：
>
> - ==超时重传==**是TCP协议保证数据可靠性的一个重要机制**，==其原理是==在发送一个数据以后就开启一个计时器，在一定时间内如果没有得到发送数据报的ACK报文，那么就重新发送数据，直到发送成功为止 .
>
> - 但是**如果发送端接收到3个以上的重复ACK，TCP就意识到数据发生丢失，需要重传。这个机制不需要等到重传定时器超时，所以叫做==快速重传==**，而快速重传后没有使用慢启动算法，而是拥塞避免算法，所以这又叫做快速恢复算法。  
>
> :poultry_leg:具体的区别：
>
> - 超时重传RTO[Retransmission Timeout]超时，TCP会重传数据包。TCP认为这种情况比较糟糕，反应也比较强烈。最为早期的TCP Tahoe算法就只使用上述处理办法，但是**由于一丢包就一切重来，导致cwnd又重置为1，十分不利于网络数据的稳定传递** 。
>   - 由于发生丢包，将慢启动阈值ssthresh设置为当前cwnd的一半，即ssthresh = cwnd / 2.
>   - cwnd重置为1
>   - 进入慢启动过程
> - TCP Reno算法进行了优化。当收到三个重复确认ACK时，TCP开启快速重传Fast Retransmit算法，而不用等到RTO超时再进行重传：
>   - cwnd大小缩小为当前的一半
>   - ssthresh设置为缩小后的cwnd大小
>   - 然后**进入快速恢复算法**Fast Recovery。  



> #### 快速重传为什么是3次ack以后才开始？——拓跋阿秀
>
> - 主要是为了区分包的丢失，是由什么原因引起的，而一般的TCP拥塞控制算法==以丢包作为网络进入拥塞状态的信号==
>   - 1、数据包校验和checksum出错，但对于1来说，丢包是因为偶尔的出错引起，一丢包就对半减速不合理。  
>   - 2、网络拥塞
>   - 3、网路断/故障
...
- 根据域名，进行**DNS域名解析**，得到主机ip地址；
- 浏览器利用 IP 直接与网站主机通信，三次握手，**建立 TCP 连接**。浏览器会以一个随机端口向服务端的 web 程序 80 端口发起 TCP 的连接。 
- 浏览器向主机发起一个**HTTP请求**；
- **服务器处理请求**；
- **返回响应结果**；
- 关闭TCP连接；
- **浏览器解析**HTML；浏览器布局**渲染**，呈现给用户  



### 13、DNS域名解析过程

==目的==：找到客户端发起的某个web服务器（域名：www.baidu.com）对应的IP地址

浏览器的缓存——>系统hosts文件——>本地DNS服务器——>根域名服务器——>顶级域名服务器——>权限域名服务器。

> 1. 浏览器搜索**自己的DNS缓存**
>2. 若没有，则搜索**操作系统中的DNS缓存和hosts文件**
> 3. 若没有，则操作系统将域名发送至**本地域名服务器**，本地域名服务器查询自己的DNS缓存，查找成功则返回结果，否则==依次向==**根域名服务器、顶级域名服务器、权限域名服务器**发起查询请求，最终返回IP地址给本地域名服务器
...
递归查询：本地域名服务器作为DNS客户端的身份，递归的方式**向其他更高级别的域名服务器进行递归查询**，代替主机/客户端查询（本地域名服务器代替主机/客户端查询）；

迭代查询：当根域名服务器x本地服务器发出的迭代查询请求报文时，要么给出所要查询的IP地址，要么告诉本地服务器下一步应该找哪个域名服务器y进行查询，然后**本地服务器向y进行相同方式的迭代查询**（告诉你位置，自己去找）
...
`netstats -n -p TCP | grep SYN_RECV` ，`SYN_RECE`是服务器确认接收客户端的syn请求之后的状态，等待客户端再次确认；
...
>  http是直接和tcp通信，https=http+ssl加密；**ssl加密：发送密文的一方使用对方的公钥，对，“对称的密钥”， 进行加密，然后对方用自己的私钥解密拿到“对称的密钥”**，这样可以确保交换的密钥是安全的前提下，使用对称加密方式进行通信。所以，**HTTPS采用**对称加密和非对称加密两者并用的**混合加密机制**。

#### 	15-1、HTTPS的连接过程

> 1. 首先是TCP三次握手
> 2. 客户端发起一个HTTPS连接建立请求，客户端先发一个`Client Hello`的包，在`Client Hello`里面客户端会告知服务端自己当前的一些信息，包括客户端要使用的TLS版本，支持的加密算法，要访问的域名，给服务端生成的一个随机数（Random）等。需要提前告知服务器想要访问的域名以便服务器发送相应的域名的证书过来。
> 3. 服务器响应`Server Hello`，选择一套客户端支持的加密算法，以证书的形式回发给客户端
> 4. ==客户端(SSL/TLS)解析证书验证证书合法性==，**生成对称加密的密钥**，我们将该密钥称之为client key，即客户端密钥，**用服务器的公钥对客户端密钥进行非对称加密**。
> 5. 客户端会发起HTTPS中的第二个HTTP请求，将加密之后的客户端对称密钥发送给服务器
> 6. 服务器接收到客户端发来的密文之后，会**用自己的私钥对其进行非对称解密**，解密之后的明文就是客户端密钥，然后用客户端密钥，即对称密钥，对数据进行对称加密，这样数据就变成了密文。
> 7. 服务器将客户端对称密钥加密后的密文发送给客户端
...
> 1. 什么是数字证书？
>
>    - 服务端可以向证书颁发机构CA申请证书，以避免中间人攻击（防止证书被篡改）。证书包含三部分内容：**证书内容、证书签名算法、数字签名**，签名是为了验证身份。
>
>    - **数字签名的制作过程**：
...
对称加密算法:加密和解密使用**相同密钥**的加密算法。==特点是加密速度快，但是缺点是密钥泄露会导致密文数据被破解==。常见的对称加密算法有**AES、3DES、DES、RC5、RC6**等。
...
**非对称加密算法**：非对称加密算法需要两个密钥（**公开密钥和私有密钥**）。公钥与私钥是成对存在的，如果用公钥对数据进行加密，只有对应的私钥才能解密。==这种加密算法安全性更，但是计算量相比对称加密大很多，加密和解密都很慢。==主要的非对称加密算法有：**==[RSA](https://blog.csdn.net/a745233700/article/details/102341542)==、Elgamal、DSA、D-H、ECC**。
...
> 地址解析协议，即ARP（Address Resolution Protocol），是**根据IP地址获取物理地址**的一个TCP/IP协议。
>
...
>
> - `ping`命令的作用和原理
> - [[ping命令浅析总结]](https://www.cnblogs.com/maotx/p/11941652.html)
...
### 20、tcp与udp可以使用同一个端口吗？

:star:https://mp.weixin.qq.com/s/6YocwMsRHPrQ37TqwBaTBw，端口问题集合

### 21、既然有了HTTP协议，为什么还要有**RPC**？

:star:https://mp.weixin.qq.com/s/qmnfmUCdekEt1xG0hp_4MQ， 小林大佬

### 22、[微信网页版二维码扫码过程发生了什么？](https://blog.csdn.net/qq_40212930/article/details/105753663?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522166040117016782184697675%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=166040117016782184697675&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~baidu_landing_v2~default-2-105753663-null-null.142^v40^pc_rank_34_2,185^v2^control&utm_term=%E5%BE%AE%E4%BF%A1%E6%89%AB%E7%A0%81%E8%BF%87%E7%A8%8B&spm=1018.2226.3001.4187)

### 23、[HTTP怎么保证可靠传输？](https://blog.csdn.net/da___vinci/article/details/121808112?utm_medium=distribute.pc_relevant.none-task-blog-2~default~baidujs_utm_term~default-0-121808112-blog-121818343.t5_layer_eslanding_C_4&spm=1001.2101.3001.4242.1&utm_relevant_index=3)
...
### :star:[内存管理相关](https://blog.csdn.net/xiaowanziddd/article/details/124350296?ops_request_misc=&request_id=&biz_id=102&utm_term=%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F%E5%85%AB%E8%82%A1%E6%96%87&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduweb~default-0-124350296.142^v40^pc_rank_34_2,185^v2^control&spm=1018.2226.3001.4187)
...
从 Linux 内核 `2.4` 版本开始起，对于支持网卡支持 SG-DMA 技术的情况下， `sendfile()` 系统调用的过程发生了点变化，如果网卡支持 SG-DMA（*The Scatter-Gather Direct Memory Access*）技术（和普通的 DMA 有所不同），我们可以进一步减少通过 CPU 把内核缓冲区里的数据拷贝到 socket 缓冲区的过程。。这就是所谓的**零拷贝（\*Zero-copy\*）技术，因为我们没有在内存层面去拷贝数据，也就是说全程没有通过 CPU 来搬运数据，所有的数据都是通过 DMA 来进行传输的。**零拷贝技术的文件传输方式相比传统文件	传输的方式，减少了 2 次上下文切换和数据拷贝次数，**只需要 2 次上下文切换和数据拷贝次数，就可以完成文件的传输，而且 2 次的数据拷贝过程，都不需要通过 CPU，2 次都是由 DMA 来搬运。**所以，总体来看，**零拷贝技术可以把文件传输的性能提高至少一倍以上**。
...
>[彻底弄懂 Linux 下的文件描述符（fd）](https://blog.csdn.net/yushuaigee/article/details/107883964?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522165959798816782184667043%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=165959798816782184667043&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~top_positive~default-1-107883964-null-null.142^v39^pc_rank_34_2&utm_term=%E6%96%87%E4%BB%B6%E6%8F%8F%E8%BF%B0%E7%AC%A6&spm=1018.2226.3001.4187)
>
>文件描述符`fd`存放在什么位置？
>
>> 一个 Linux 进程启动后，会在内核空间中创建一个 PCB 控制块，PCB 内部有一个文件描述符表（File descriptor table），记录着当前进程所有可用的文件描述符，也即当前进程所有打开的文件。
>>
>> - 每个进程在`Linux`内核中都有一个`task_struct结构体`来维护进程相关的信息,称为进程描述符(Process Descriptor),而在操作系统理论中称为`进程控制块 (PCB,Process Control Block)`。
>>
>> - `task_struct`中有一个`指针(struct files_struct *files)`指向`files_struct结构体`,称为**文件描述符表**，记录该进程打开的所有文件。该表中有一个域(struct file * fd_array[NR_OPEN_DEFAULT]),为文件描述符数组，该数组的每个元素指向已打开的文件的指针

---

### 10、场景题：CPU突然飙高，怎么排查？

:star:https://mp.weixin.qq.com/s/99tXiy969eqaXwaiRETImw
...
> ==跳表==
>
> - 相当于基于单链表加多级索引的结构实现了二分查找，查找的时间复杂度为O(logxn)
...
#### 11-1、关系型 & 非关系型NoSQL数据库

- 非关系型数据库也叫[**NoSQL**](https://blog.csdn.net/weixin_43637366/article/details/113105005?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522166139702916782246493581%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=166139702916782246493581&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~top_positive~default-1-113105005-null-null.142^v42^pc_rank_34,185^v2^control&utm_term=nosql&spm=1018.2226.3001.4187)，采用键值对的形式进行存储。它的读写性能很高，易于扩展，可分为内存性数据库以及文档型数据库，比如 Redis与Memcached（k-v内存存储型），Mongodb(非关系型中最接近关系型数据库的，文档型)，HBase等等。适合使用非关系型数据库的场景：日志系统，地理位置存储，数据量巨大，高可用；

![](myassets/image-20220825105703658.png)

#### 11-2、Redis 与 Memcached

![image-20220825110356494](myassets/image-20220825110356494.png)

#### 11-3、[Redis 与 MongoDB](https://blog.csdn.net/nieyayun2019/article/details/120346132)

#### 11-4、[MongoDB和MySQL的区别是什么](https://www.php.cn/mysql-tutorials-485232.html)
...
>
> :star:上面链接中详细介绍了`redolog`与`binlog`
>
> 
>
...
- https://mp.weixin.qq.com/s/okN0wkKdPbGIVOa7Q6pkXQ 
  - **要求在海量数据中找出重复次数最多的一个/前N个数据**，我们的解决方法也很朴实：**分而治之/Hash映射 + HashMap/前缀树统计频率 + 堆/快速/归并排序**，具体来说就是先做hash，然后求模映射为小文件，求出每个小文件中重复次数最多的一个，并记录重复次数，最后利用堆这个数据结构高效地取出前N个出现次数最多的数据。
- https://mp.weixin.qq.com/s/pQpbt2WUWuSnr2OlX3K6ag——`bitmap`的应用
...
- 8/18 4399笔试题两道
  ...
  ```C++
  // 给定数字N，输出 大于等于N且从高位到地位非严格单调递减的 数字
  // 输入：19， 输出：20
  // 输入：3223， 输出：3300
  // 输入：4321， 输出：4321
  #include <iostream>
  ...
  int GetDecreasingBiggerNum(int N) {
      ...
      int n = s.size();
      int index_of_zero = -1; // 记录下原来N，存在递增位置最左边的j，最后的i位置+1，j位置及其之后均为0
      if (n == 1) return N;
      for (int i = n - 2, j = n - 1; i >= 0; i--, j--) {
          if (s[i] < s[j]) { // 存在递增的一对[i, j]
              s[i]++;
              s[j] = 0;
              index_of_zero = j;
          }
      }
      if (index_of_zero == -1) return N; // 说明不存在任一对[i,j]是递增的
      int res = 0;
      for (int i = 0; i < s.size(); i++) {
          char c = i >= index_of_zero ? '0' : s[i];
          res = res * 10 + c - '0';
      }
      return res;
  }
  int main() {
      int N;
      cin >> N;
      cout << GetDecreasingBiggerNum(N);
      return 0;
  }
  
  
  // 将一个数组nums，划分为两个数组，使得这两个数组和，之差最小——————排序+贪心
  #include <iostream>
  #include <string>
  #include <vector>
  #include <algorithm>
  ...
  int main() {
      ...
      while (cin >> num) {
          ...
          char c; // 定义一个字符，用于接收输入数字之间的空格，否则只接收到一个数字就退出while了
          cin >> c;
      }
      ...
      for (int num : nums) {
          // cout << num << " ";
          if (sum1 <= sum2) { // 比较当前数组和较小的一个，加上当前的数字
              sum1 += num;
          }
          else {
              sum2 += num;
